...
В приложении есть карта с активными объявлениями, которы также можно отфильтровать по категориям. При клике по точке на карте можно увидеть короткую информацию о продукте и ссылку на страницу объявления.
...
В личном кабинете можно изменить информацию о себе, посмотреть активные и архивные объявления. Активные объявления можно редактировать и снимать с публикации.
